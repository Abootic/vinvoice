      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form  v-on:submit="create($event)" >
            <div class="mb-3">
              <label for="recipient-name" class="col-form-label">{{ languageStore.TRANSLATE("c_customerName") }}</label>
              <input type="text" class="form-control" v-model="customerData.name" id="recipient-name">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control" v-model="customerData.email" id="recipient-name">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
            <button type="button" class="btn btn-secondary"  @click="close" data-bs-dismiss="modal">{{ languageStore.TRANSLATE("closeBtn") }}</button>
          <button type="submit" class="btn btn-primary" id="save-btn" :disabled="disable" >{{ languageStore.TRANSLATE("saveBtn") }}</button>
            </div>
          </form>
        </div>
